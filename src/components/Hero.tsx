        ...
        <div className="banner-overlay bg-transparent pt-20 sm:pt-24 md:pt-32 w-full">
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              <motion.h1 className="banner-title text-white" variants={itemVariants}>智能纺织技术的未来在这里</motion.h1>
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6" variants={itemVariants}>
                我们将AI传感器集成到服装、鞋履和穿戴设备中。
              </motion.p>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        delay: 0.6
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">智能纺织品</h3>
            <p className="text-gray-600 text-xs md:text-sm">智能纺织品传感器无缝集成到服装和鞋履中。</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">适应性AI</h3>
            <p className="text-gray-600 text-xs md:text-sm">行业特定算法将纺织传感器数据转换为有意义的见解。</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">跨行业</h3>
            <p className="text-gray-600 text-xs md:text-sm">运动、军事、医疗、工业和专业环境的解决方案。</p>
          </motion.div>
        </motion.div>
      </div>
    </motion.div>;
